...
config_file = None
if len(sys.argv) < 2:
    print("Usage:{} [-C config.txt] fileList4query dir4db resultFile".format(sys.argv[0]))
    sys.exit()
...
print("{} density:{}, fanout:{}, search_depth:{}, min_count:{} ncores:{}".format(sys.argv[0], density, fanout,
                                                                                 search_depth, min_count, ncores))
