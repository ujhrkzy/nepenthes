...
config_file = None
if len(sys.argv) < 2:
    print("Usage:{} [-C config.txt] fileList4db dir4db".format(sys.argv[0]))
    sys.exit()
...
print("{} density:{}, fanout:{}, bucketsize:{}, ncores:{}".format(sys.argv[0], density, fanout, bucketsize, ncores))
